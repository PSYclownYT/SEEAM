...
pygame.display.set_caption("Peak Clicker")
...
def main_loop():
    ...
    while game_running:
        ...
        DrawText("Peakest Clicker", black, light_blue, 400, 100, 50)
        DrawText(str(f'{coins:.2f}') + " coins", black, light_blue, 100, 50, 20)
        DrawText("upgrade clicker " + str(cost), black, light_blue, 700, 300, 20)
        DrawText("buy (paid) laborer " + str(cost2), black, light_blue, 150, 370, 20)
        DrawText("Verorsn: " + ver, black, light_blue, 650, 50, 20)
